...
class DictizableMixin(object):
    ...
    def autogenerated_dict_structure(self):
        return {
            "_a": self.__mapper__.columns.keys(),
        }

    @classmethod
    def input_data_schema(cls):
        return cls._input_data_schema_ or generate_input_data_schema(cls)
    ...
    def max_permissible_dict_structure(cls):
        return {
            "_a": cls.__mapper__.columns.keys(),
            "_r": {rel_name: {'_a': rel_property.mapper.columns.keys()}
    ...
    def todict_using_struct(self, dict_struct={}):
        ...
        """
        result = self.serialize_attrs(*dict_struct.get('_a', []))
        for rel, rel_dict_struct in dict_struct.get('_r', {}).items():
