...
class DictizableMixin(object):
    ...
    def autogenerated_dict_structure(self):
        return {
            "attrs": self.__mapper__.columns.keys() + self.col_assoc_proxy_keys()
        }
    ...
    def todict_using_struct(self, dict_struct=None):
        """
            dict_struct:
            {
                'attrs': ['id', 'created_at'],
        ...
        if dict_struct is None and self._autogenerate_dict_struct_if_none_:
            ...
            dict_struct["attrs"] = self.autogenerated_dict_structure()["attrs"]
    ...
    def serialize_attrs(self, *args):
        ...
        cls = type(self)
        return dict([(a, getattr(self, a)) for a in args if hasattr(cls, a)])
