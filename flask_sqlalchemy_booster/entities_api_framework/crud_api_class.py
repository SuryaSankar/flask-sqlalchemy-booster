        ...
        for entity in self.entities:
            ...
            if Patch in permitted_actions:
                ...
                patch_func = patch_op.view_func or construct_patch_view_function(
                    ...
                    pre_processors=patch_op.before_save_handlers,
                    processors=patch_op.processors,
                    post_processors=patch_op.after_save_handlers,
            ...
            if BatchSave in permitted_actions:
                ...
                batch_save_func = batch_save_op.view_func or construct_batch_save_view_function(
                    ...
                    post_processors_for_put=fetch_nested_key(entity, 'put.before_save_handlers'),
                    extra_pre_processors=batch_save_op.extra_before_save_handlers,
                    extra_post_processors=batch_save_op.extra_after_save_handlers,
